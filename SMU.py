...
## EXAMPLES
#SMUSetup(0.001)
#Test('IRFZ44N_box_AloopB').AloopB(0.5,2,0.5,0,1.2,0.1)
#Test('IRFZ44N_box_BloopA').BloopA(0,1.2,0.4,0.5,2,0.1)
#Test('IRFZ44N_box_TimeTest').TimeTest(2.75,0.5,5000)
#Graphs_Overlay('IRFZ44N_box_AloopB','IRFZ44N_box_BloopA').Loops_Overlay()

#Graph('IRFZ44N_box_AloopB').Loops()
#Graph('IRFZ44N_box_BloopA').Loops()
#Format('IRFZ44N_box_BloopA').AddTransconductance()
#Graph('IRFZ44N_box_BloopA').Loop_and_Transconductance()
#Graph('IRFZ44N_box_BloopA').Transconductance()
